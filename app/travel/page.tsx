...
export const metadata: Metadata = {
  title: "Travel Log | Dennis Mende",
  description: "A visual record of the countries I've explored. Traveling for new perspectives and understanding different cultures.",
  openGraph: {
    title: "Travel Log | Dennis Mende",
    description: "A visual record of the countries I've explored around the world.",
    url: "https://dennismende.com/travel",
    type: "website",
  },
};
