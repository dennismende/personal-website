...
import { fetchRecentPosts, urlFor, type Post } from "@/lib/sanity";
...
export default async function HomePage() {
  ...
  return (
    <>
      <PersonSchema
        name="Dennis Mende"
        jobTitle="Director, Digital Engineering & Strategy"
        description="Senior Technology Leader uniting commercial strategy with engineering excellence. Leading 120+ FTE organizations with multi-million Euro P&L responsibility."
        url="https://dennismende.com"
        image="https://dennismende.com/profile.png"
        sameAs={[
          "https://www.linkedin.com/in/dennismende",
          "https://github.com/dennismende",
        ]}
      />
      <WebSiteSchema
        name="Dennis Mende"
        url="https://dennismende.com"
        description="Personal website of Dennis Mende - Senior Technology Leader"
      />
